    ...
    <div class="col-md-12">
        <h3 class="text-center">Visits</h3>
                ...
                <div class="card card-body bg-light mb-2">                   
                    ...
                    <p>{!!Html::linkRoute('derma_visit.show','Details',[$visit->id],['class'=>'btn btn-outline-info btn-block'])!!}</p>
                </div>
                @endforeach
    ...
    <div class="col-md-4 mx-auto">
            <div class="card card-body bg-light">
                ...
                <div class="row">
                        <div class="col-md-12">
                            @if($patient->image)
                            <a href="{{route('docxxxx',$patient->id)}}" class="btn btn-outline-dark btn-block">Download Previous Patient's File</a>
                            @endif
                            <a href="{{route('derma_visit',$patient->id)}}" class="btn btn-primary btn-block"><span class="fa fa-medkit"></span> Add New Visit </a>
                        </div>
                </div>
            </div>
        </div>
